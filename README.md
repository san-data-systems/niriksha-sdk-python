...
nirikshaai.init(
    ...
    otlp_endpoint="ingest.niriksha.ai:4317",  # SaaS: OTLP gateway is separate from the REST API
    api_key="nai_...",
...
| `otlp_endpoint` | `str` | `None` | Override the gRPC OTLP address (`host:port`, no scheme). SaaS: `ingest.niriksha.ai:4317` |
